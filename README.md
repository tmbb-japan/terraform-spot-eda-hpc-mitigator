...
* **Cloud Provider:** AWS
* **Agent Script:** Python 3.x (Standard Libraries Only - `urllib`, `signal`, `subprocess`)
* **OS Target:** Amazon Linux 2023 / Ubuntu 22.04 LTS
---
...
* 체크포인트 주기와 RPO/RTO 목표를 워크로드 특성에 맞게 수치화
* 스케줄러(LSF/Slurm) API 권한, 재시도 정책, 실패 시 롤백 플로우 정의
* EFS 성능 모드/처리량 모드와 대체 스토리지(S3, FSx) 조합 검토
* Spot-OD 혼합 용량 정책(비용 vs 복구속도) 사전 합의